...
int main() {
    ...
    while(1){
        printf("\n__________Hospital Appointment System__________\n");
        printf("\n------Select Area------\n1. Clifton\n2. DHA\n3. Gulshan-e-Iqbal\n4. Saddar\n5. North Nazimabad\n");
        scanf("%d", &area);
        ...
        switch(hospital) {
            case 1:
                if(area==1) strcpy(hospitalName,"Agha Khan Health Centre");
                else if(area==2) strcpy(hospitalName,"PAF Hospital");
                else if(area==3) strcpy(hospitalName,"Liaquat National Hospital");
                else if(area==4) strcpy(hospitalName,"JPMC");
                else strcpy(hospitalName,"Ziauddin Hospital");
                break;
            case 2:
                if(area==1) strcpy(hospitalName,"Ziauddin Hospital");
                else if(area==2) strcpy(hospitalName,"MediCare Cardiac & General Hospital");
                else if(area==3) strcpy(hospitalName,"Mamji Hospital");
                else if(area==4) strcpy(hospitalName,"Civil Hospital");
                else strcpy(hospitalName,"Saifee Hospital");
                break;
            case 3:
                if(area==1) strcpy(hospitalName,"South City Hospital");
                else if(area==2) strcpy(hospitalName,"Australian Concept Fertility Centre");
                else if(area==3) strcpy(hospitalName,"Tabba Heart Institute");
                else if(area==4) strcpy(hospitalName,"National Institute of Child Health");
        ...
        printf("Your Appointment has been made with %s\nDate: %s\nArea: %s\nHospital: %s\nCause of Visit: %s\n",
               doctor, date, areaName, hospitalName, reason);
